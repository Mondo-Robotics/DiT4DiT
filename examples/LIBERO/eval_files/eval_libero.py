    ...
    for task_id in tqdm.tqdm(range(num_tasks_in_suite)):
        ...
        for episode_idx in tqdm.tqdm(range(args.num_trials_per_task)):
            ...
            while t < max_steps + args.num_steps_wait:
                ...
                # ModelClient will resize, concat primary+wrist, sin/cos encode state, and pad
                example_dict = {
                    "image": observation["observation.primary"][0],          # (H, W, 3)
                    "wrist_image": observation["observation.wrist_image"][0], # (H, W, 3)
                    "lang": observation["instruction"][0],
                    "state": observation["observation.state"][0],             # (D,)
                }
